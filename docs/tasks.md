...
- [ ] 2.1 `Nodes::CreateService` + `spec/services/nodes/create_service_spec.rb`
- [ ] 2.2 `Nodes::MoveService` + `spec/services/nodes/move_service_spec.rb`
- [ ] 2.3 `Nodes::DestroyService` + `spec/services/nodes/destroy_service_spec.rb`
